    ...
    <footer className="bg-primary text-white pt-8 pb-4 mt-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              ...
              <a href="#" className="text-white hover:text-blue-200 transition-colors" aria-label="Twitter">
                <Twitter size={20} />
              </a>
              <a href="#" className="text-white hover:text-blue-200 transition-colors" aria-label="Instagram">
                <Instagram size={20} />
              </a>
              <a href="#" className="text-white hover:text-blue-200 transition-colors" aria-label="Youtube">
                <Youtube size={20} />
              </a>
            </div>
          </div>
        ...
        <div className="mt-8 pt-4 border-t border-white/20 text-center text-sm">
          <p>म्युज खबर - हाम्रो लुम्बिनी, हाम्रो खबर</p>
        </div>
      </div>
    </footer>
  );
